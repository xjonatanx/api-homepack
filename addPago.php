...
if($resultedsignature == $recieved_signature) {
    ...
    $sql = "INSERT INTO pagos (orden_compra, data, estado, total, created_at, fk_id_usuario) VALUES ('$orden_compra', '$data', '$estado', $total, NOW(), $fk_id_usuario)";
    
    if ($conn->query($sql) === TRUE) {
        $myObj->status = 1;
        $myObj->mesagge = "Transacción ingresada correctamente..";
