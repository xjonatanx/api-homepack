...
require 'vendor/autoload.php';
    ...
    if ($result = $conn->query("SELECT nombre FROM usuarios WHERE usuario = '$usuario' OR email = '$email';")) {
        $row_cnt = $result->num_rows;
        $result->close();
        if($row_cnt > 0) {
            $myObj->status = 0;
            $myObj->mesagge = "El usuario ingresado ya existe en plataforma.";
    ...
    $sql = "INSERT INTO usuarios (nombre, usuario, telefono, perfil, rut, email, fecha_nacimiento, comuna, passwd) VALUES ('$nombre', '$usuario', '$telefono', '$perfil', '$rut', '$email', '$fecha_nacimiento', '$comuna', '$passwd')";
    
    if ($conn->query($sql) === TRUE) {
        sendMail($nombre, $usuario, $perfil, $rut, $email, $fecha_nacimiento, $comuna, $telefono);
        $myObj->status = 1;
        $myObj->mesagge = "Usuario registrado correctamente, se ha enviado a tu correo electrónico los datos de tu cuenta.";
        $myJSON = json_encode($myObj);
        echo $myJSON;
    } else {
        $myObj->status = 0;
        $myObj->mesagge = "Ocurrió un problema al registrar la transacción.";
        $myJSON = json_encode($myObj);
        echo $myJSON;
    } 
...
function sendMail($nombre, $usuario, $perfil, $rut, $email, $fecha_nacimiento, $comuna, $telefono)
{
    ...
    try {
        ...
        $mail->Subject = utf8_decode('Bienvenido a Home Pack Chile');
        $mail->Body    = utf8_decode('
            ...
            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 40px;padding-left: 40px;" align="center"><![endif]--><img align="center" alt="Im an image" border="0" class="center fixedwidth" src="https://yitp.cl/img_hpchile/registrarse.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 160px; display: block;" title="Im an image" width="160"/>
            <!--[if mso]></td></tr></table><![endif]-->
            </div>
            ...
            <p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;"><span style="font-size: 30px; color: #2b303a;"><strong style="color: #2b303a; font-size: 30px;"><br>Bienvenido</strong></span></p>
            </div>
            </div>
            <!--[if mso]></td></tr></table><![endif]-->
            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 40px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, sans-serif"><![endif]-->
            ...
            <br>Estamos felices de que nos hayas elegido, tenemos el gusto de informarte que tu cuenta ha sido creada correctamente, a continuación se detallan los datos de su perfil:
            </span></p>
            <br>
             <table style="font-size: 15px; line-height: 1.5; word-break: break-word; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 23px; margin: 0; color: #808389";>
                <tr>
                  <td style="width:130px;">Nombre:</td>
                  <td>'.$nombre.'</td>
                </tr>
                <tr>
                  <td style="width:130px;">RUT:</td>
                  <td>'.$rut.'</td>
                </tr>
                <tr>
                  <td style="width:130px;">Nacimiento:</td>
                ...
                <tr>
                  <td style="width:130px;">Teléfono:</td>
                  <td>'.$telefono.'</td>
                </tr>
                <tr>
                  <td style="width:130px;">Comuna:</td>
                  <td>'.$comuna.'</td>
                </tr>
                <tr>
            ...
            <tbody>
            <tr style="vertical-align: top;" valign="top">
            <td style="word-break: break-word; vertical-align: top; padding-top: 18px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" valign="top">
            <table align="center" cellpadding="0" cellspacing="0" class="social_table" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-tspace: 0; mso-table-rspace: 0; mso-table-bspace: 0; mso-table-lspace: 0;" valign="top">
            <tbody>
            <tr align="center" style="vertical-align: top; display: inline-block; text-align: center;" valign="top">
            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;" valign="top"><a href="https://www.facebook.com/113580153889962/posts/113582983889679/?sfnsn=mo" target="_blank"><img alt="Facebook" height="32" src="https://yitp.cl/img_hpchile/facebook.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="Facebook" width="32"/></a></td>
            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;" valign="top"><a href="https://www.instagram.com/homepackchile/" target="_blank"><img alt="Instagram" height="32" src="https://yitp.cl/img_hpchile/instagram.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="Instagram" width="32"/></a></td>
            </tr>
            </tbody>
            </table>
            </td>
