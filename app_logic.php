...
if (isset($_POST['reset-password'])) {
  ...
  if (empty($email)) {
    array_push($errors, "Tu email es requerido");
  }else if(mysqli_num_rows($results) <= 0) {
    array_push($errors, "Disculpa, no existen usuarios en el sistema con este email");
  }
...
if (isset($_POST['new_password'])) {
  ...
  if (empty($new_pass) || empty($new_pass_c)) array_push($errors, "La contraseña es requerida");
  if ($new_pass !== $new_pass_c) array_push($errors, "Las contraseñas no son iguales");
  if (count($errors) == 0) {
    ...
    if ($email) {
      ...
      $sql = "UPDATE usuarios SET passwd='$new_pass' WHERE email='$email'";
      $results = mysqli_query($conn, $sql);
      header('location: https://plataforma.homepackchile.cl');
    }
  }
}
...
function sendMail($email, $token)
{
    ...
    try {
        ...
        $mail->Body    = utf8_decode('
            ...
            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 40px;padding-left: 40px;" align="center"><![endif]--><img align="center" alt="Im an image" border="0" class="center fixedwidth" src="https://yitp.cl/img_hpchile/contrasena.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 160px; display: block;" title="Im an image" width="160"/>
            <!--[if mso]></td></tr></table><![endif]-->
            </div>
            ...
            <p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;"><span style="font-size: 30px; color: #2b303a;"><strong style="color: #2b303a; font-size: 30px;"><br>Recuperación de contraseña</strong></span></p>
            </div>
            </div>
            <!--[if mso]></td></tr></table><![endif]-->
            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 40px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, sans-serif"><![endif]-->
            ...
            <br>Estimado usuario /a<br><br> junto con saludar le informamos que hemos recibido una petición para recuperar la contraseña de '.$email.', para continuar con el proceso debes hacer clic en el siguiente botón.<br> Esto le permitirá cambiar la contraseña en nuestra plataforma Home Pack Chile.
            </span></p>
            </div>
            </div>
            <!--[if mso]></td></tr></table><![endif]-->
