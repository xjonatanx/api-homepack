<?php
    ...
    if($resultedsignature == $recieved_signature) {
        ...
        $count = $conn->query("
            ...
            WHERE despachos.id_chofer IS NULL AND despachos.retirado = 0 AND despachos.sobrancia = 0 AND (usuarios.nombre LIKE '%$search%' OR despachos.orden_compra LIKE '%$search%' OR despachos.numero_seguimiento LIKE '%$search%');");
