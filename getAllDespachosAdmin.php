<?php
    ...
    if($resultedsignature == $recieved_signature) {
        ...
        $count = $conn->query("SELECT COUNT(*) AS countDespachos FROM despachos WHERE orden_compra LIKE '%$search%' OR numero_seguimiento LIKE '%$search%';");
        ...
        $result = $conn->query("
            ...
            WHERE despachos.orden_compra LIKE '%$search%'  
            OR despachos.numero_seguimiento LIKE '%$search%' 
