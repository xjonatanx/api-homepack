<?php
    ...
    if($resultedsignature == $recieved_signature) {
        ...
        if($perfil == "admin") {
            ...
            WHERE despachos.retirado = 1 AND despachos.centro_distribucion = 1 AND despachos.a_destino = 0 AND despachos.sobrancia = 0 AND  (usuarios.nombre LIKE '%$search%' OR despachos.orden_compra LIKE '%$search%' OR despachos.numero_seguimiento LIKE '%$search%');");
        ...
        if($perfil == "chofer") {
            ...
            LEFT JOIN usuarios
            ON despachos.id_chofer = usuarios.id
            WHERE despachos.id_chofer = $id_chofer AND despachos.retirado = 1 AND despachos.centro_distribucion = 1 AND despachos.a_destino = 0 AND despachos.sobrancia = 0 AND  (usuarios.nombre LIKE '%$search%' OR despachos.orden_compra LIKE '%$search%' OR despachos.numero_seguimiento LIKE '%$search%');");
            $fila = $count->fetch_assoc();
            $total = $fila['countDespachos'];
