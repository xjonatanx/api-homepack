        ...
        <div class="row align-items-center" style="height: 100vh;">
            <div class="col">
                <div class="card" style="max-width: 500px; margin: 0 auto; padding: 30px;">
                    ...
                    <center>
                        <button class="btn btn-secondary" type="submit" onClick="location.href='https://plataforma.homepackchile.cl'" style="background-color: purple; border: 1px solid purple; margin-top: 10px;" name="reset-password">Regresar a plataforma</button>
                    </center>
                </div>
            </div>
       </div>
