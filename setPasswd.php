...
if($resultedsignature == $recieved_signature) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        while ( $row = $result->fetch_assoc())  {
            sendMail($row["usuario"], $_POST["passwd"], $row["nombre"], $row["email"]);
        }
        $myObj->status = 1;
        $myObj->mesagge = "Contraseña actualizada correctamente, se han enviado las nuevas credenciales a su correo.";
        $myJSON = json_encode($myObj);
        echo $myJSON;
    } else {
        $myObj->status = 0;
        $myObj->mesagge = "Ocurrió un problema al actualizar su contraseña.";
        $myJSON = json_encode($myObj);
        echo $myJSON;
    }
...
function sendMail($usuario, $passwd, $nombre, $email)
{
    ...
    try {
        ...
        $mail->Body    = utf8_decode('
            <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 40px;padding-left: 40px;" align="center"><![endif]--><img align="center" alt="Im an image" border="0" class="center fixedwidth" src="https://yitp.cl/img_hpchile/recovery.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 160px; display: block;" title="Im an image" width="160"/>
                    <!--[if mso]></td></tr></table><![endif]-->
                    </div>
                    ...
                    <p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;"><span style="font-size: 30px; color: #2b303a;"><strong style="color: #2b303a; font-size: 30px;"><br>Cambio de contraseña</strong></span></p>
                    </div>
                    </div>
                    <!--[if mso]></td></tr></table><![endif]-->
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 40px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, sans-serif"><![endif]-->
                    ...
                    <br>Estimado '.$nombre.'<br><br> junto con saludar le informamos que su contraseña ha sido actualizada, sus nuevas credenciales para acceder a la plataforma Home Pack Chile son las siguientes:
                    </span></p>
                    <br>
